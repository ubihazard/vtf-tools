	...
	*/
	...
	public:
		...
		*/
		...
		inline vlUInt GetThumbnailDataSize() const
		{
			return this->uiThumbnailBufferSize;
		}
		inline vlUInt GetImageDataSize() const
		{
			return this->uiImageBufferSize;
		}
		...
		*/
		...
		inline SVTFHeader const* GetHeaderData() const
		{
			return this->Header;
		}
