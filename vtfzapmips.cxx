...
usage:
	...
	auto const vtf_size_new = off + mip_size;
	...
	// Preserve just the largest mipmap
	vtf_force_72(vtf, vtf_new, true);
	memmove((char*)vtf_new + off
	, (char*)vtf_new + off + img_size - mip_size
	, mip_size);
	*(unsigned int*)((char*)vtf_new + VTF_HDR_OFF_FLAGS) = flags
	| TEXTUREFLAGS_NOMIP | TEXTUREFLAGS_NOLOD;
	*(char*)((char*)vtf_new + VTF_HDR_OFF_MIPS) = 1;
